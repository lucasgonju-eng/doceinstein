...
Este projeto publica automaticamente no Hostinger via GitHub Actions quando houver push na branch `main`, usando SFTP com usuário e senha.
...
- Garantir acesso SSH/SFTP habilitado no plano da hospedagem.
...
- `HOSTINGER_PASSWORD` (senha SSH/SFTP)
